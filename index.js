...
const googlescrape = async (browser, product_to_search, today) => {
	...
	await Promise.all([
		...
		page.goto(
			`https://www.google.com/search?rlz=1C1GCEA_enGB1063GB1063&q=${product_to_search}&tbm=shop&sa=X&ved=2ahUKEwjNwYGnoouAAxUQKFkFHZvVAnkQ0pQJegQICxAB&biw=1920&bih=929`
		),
	]);
...
const main = async (
	keywords,
	datasetId = "testds",
	tableId_sponsor = "testUKSponsorTable",
	tableId_organic = "testUKOrganicTable"
) => {
	const d = new Date();
